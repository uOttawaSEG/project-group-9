...
public class SessionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query upcomingQ = database.collection("Sessions").whereEqualTo("tutorId", newTutor).whereGreaterThan("date", now).orderBy("date", Query.Direction.ASCENDING);

        Query pastQ = database.collection("Sessions").whereEqualTo("tutorId", newTutor).whereLessThan("date", now).orderBy("date", Query.Direction.DESCENDING);
    ...
    private void bindPastIncomingData(SessionView holder, Session session){
        ...
        if (student != null) {
            ...
            holder.textStudentName.setText("No Student name.");
        }

        if(session.getCourse() != null){
            holder.textCourseCode.setText(session.getCourse());
        } else {
            holder.textCourseCode.setText("No course selected.");
        }
